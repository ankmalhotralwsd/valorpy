...
field_of_view = 100
field_of_view_scaling_factor = math.tan(field_of_view/2)
...
def perspective_x_coords(a):
    PERSPECTIVE_MATRIX = [[aspect_ratio * (1/field_of_view_scaling_factor), 0, 0, 0],
                            [0, 1/field_of_view_scaling_factor, 0, 0],
